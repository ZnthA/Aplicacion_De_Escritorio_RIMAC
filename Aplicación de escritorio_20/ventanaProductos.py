...
qtCreatorFile = "ventanaProductos.ui" # Nombre del archivo aquí.

Ui_MainWindow, QtBaseClass = uic.loadUiType(qtCreatorFile)

class RegistroProductos(QtWidgets.QMainWindow, Ui_MainWindow):
    def __init__(self):
    ...
    def grabar(self):
        try:
            ...
            QtWidgets.QMessageBox.information(self, "Modificar Producto", "Modificado correctamente...!!!", QtWidgets.QMessageBox.Ok)
