...
class ArregloFactura:
    ...
    def cargar(self):
        archivo = open("Facturas.txt", "r", encoding = "utf-8")
    ...
    def grabar(self):
        archivo = open("Facturas.txt", "w+", encoding = "utf-8")
        for i in range(self.tamañoFactura()):
            archivo.write(str(self.devolverFactura(i).getNDocumentoVenta()) + "," + str(self.devolverFactura(i).getFecha()) + ","+ str(self.devolverFactura(i).getIgv()) + ","+ str(self.devolverFactura(i).getTotalPrecioVenta()) + ","+ str(self.devolverFactura(i).getRuc()) + ","+ str(self.devolverFactura(i).getEstado()) + "\n")
        archivo.close()
